...
namespace Animancer
{
    ...
    public abstract partial class AnimancerState : AnimancerNode, IAnimationClipCollection
    {
        ...
        public override AnimancerLayer Layer => _Parent != null ? _Parent.Layer : null;
        ...
        /// <summary>
        /// Returns the <see cref="AnimancerNode.Name"/> if one is set, otherwise a string describing the type of this
