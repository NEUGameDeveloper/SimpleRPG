...
namespace Animancer
{
    partial struct AnimancerEvent
    {
        ...
        public sealed partial class Sequence : IEnumerable<AnimancerEvent>
        {
            ...
            /// <para></para>
            /// Animancer Lite does not allow the <see cref="normalizedTime"/> to be changed in Runtime Builds.
            /// </summary>
            ///
            /// <example><code>
            ...
            public void AssertNormalizedTimes()
            {
                ...
                throw new ArgumentOutOfRangeException($"The {nameof(normalizedTime)} of an event in the {nameof(Sequence)} is" +
            ...
            /// <see cref="WarningType.DuplicateEvent"/>.
            /// </summary>
            [System.Diagnostics.Conditional(Strings.Assertions)]
            private static void AssertEventUniqueness(Action oldCallback, Action newCallback)
            {
                ...
                {
                    WarningType.DuplicateEvent.Log($"The {nameof(AnimancerEvent)} being added" +
            ...
            {
#if UNITY_ASSERTIONS
                if (WarningType.DuplicateEvent.IsDisabled() || index == 0)
                    return;
