...
namespace Animancer
{
    ...
    public class ControllerState : AnimancerState
    {
...
#if UNITY_ASSERTIONS
        /// <summary>[Assert-Only]
        /// Animancer Events do not work properly on <see cref="ControllerState"/>s.
        /// </summary>
        ...
        public override bool ApplyAnimatorIK
        {
            ...
            {
                if (value)
                    WarningType.UnsupportedIK.Log($"IK cannot be dynamically enabled on a {nameof(ControllerState)}." +
        ...
        public class Transition : Transition<ControllerState>
        {
            ...
            /// <summary>
            /// Creates and returns a new <see cref="ControllerState"/>.
            /// <para></para>
